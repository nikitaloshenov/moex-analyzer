"""
Скрипт массового бэктеста за 2024 год (V2: Polars + market impact).
"""
...
async def run_backtest_2024(ticker):
...
async def main():
    print("📉 Бэктест V2 за 2024…")
    start_time = datetime.now()

    tasks = [run_backtest_2024(t) for t in TICKERS_40]
    ...
    if sorted_res:
        ...
        print(f"📊 Итог 2024: Winrate {avg_winrate:.1f}% | Профит {total_market_profit:.2f} п.")
